...
export const HELP_CONTENT: Record<string, HelpEntry> = {
  ...
  pages: {
    tr: {
      title: "Sayfalar (Sayfa Kurucu)",
      steps: [
        "Bu collection, kod yazmadan yeni sayfa oluşturmayı sağlar. 'slug' alanı URL'i belirler: /{slug}.",
        "'layout' alanı bloklardan oluşur — sağ üstteki 'Blok Ekle' ile Hero, Zengin Metin, SSS Listesi, Kampanya Grid, Video veya Logo Grid bloklarından istediğinizi ekleyin.",
        "Blokları listede sürükleyerek sırasını değiştirebilirsiniz — bu, sayfadaki görünüm sırasını belirler.",
        "SEO alanlarını (seoTitle, seoDescription, ogImage) doldurmayı unutmayın — arama sonuçlarında ve paylaşımlarda bunlar görünür.",
        "Yayınlamadan önce 'Önizle' ile sonucu kontrol edin.",
      ],
    },
    en: {
      title: "Pages (Page Builder)",
      steps: [
        "This collection lets you build new pages without writing code. The 'slug' field determines the URL: /{slug}.",
        "The 'layout' field is block-based — use 'Add Block' at the top to add Hero, Rich Text, FAQ List, Campaign Grid, Video, or Logo Grid blocks.",
        "Drag blocks in the list to reorder them — this determines their order on the page.",
        "Don't forget to fill in the SEO fields (seoTitle, seoDescription, ogImage) — these show up in search results and link previews.",
