 ...
 * payload.config.ts's admin.components.views) — same DefaultTemplate-wiring
 * pattern as WaitingApprovalsView.tsx (Payload does NOT auto-wrap brand-new
 * custom view keys in the nav/topbar template, confirmed by reading
 * @payloadcms/next's RootPage source during 3.11's build).
 */
