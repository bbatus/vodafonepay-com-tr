  ...
  fields: [
    {
      ...
      unique: true,
      options: [
        { label: { tr: "Anasayfa", en: "Homepage" }, value: "anasayfa" },
        { label: { tr: "Vodafone Pay Uygulama", en: "Vodafone Pay App" }, value: "vodafone-pay-uygulama" },
        { label: { tr: "Vodafone Pay Kart", en: "Vodafone Pay Card" }, value: "vodafone-pay-kart" },
        { label: { tr: "QR ile Faturana Yansıt", en: "Bill Reflection via QR" }, value: "qr-ile-faturana-yansit" },
        { label: { tr: "Faturana Yansıt", en: "Bill Reflection" }, value: "faturana-yansit" },
        { label: { tr: "Anında Bakiye", en: "Instant Balance" }, value: "aninda-bakiye" },
      ],
    },
