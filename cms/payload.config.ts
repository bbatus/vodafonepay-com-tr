...
export default buildConfig({
  ...
  i18n: {
    ...
    // Every entry here is a Payload-shipped Turkish string that is wrong or
    // unreadable for a business editor, found by walking the panel. Overriding
    // the handful that matter beats forking the language pack.
    translations: {
      tr: {
        version: { unpublishedSuccessfully: "Yayından kaldırıldı." },
        // Payload ships "Doğru" / "Yanlış" for booleans — which in Turkish
        // reads "correct" / "incorrect", not "yes" / "no". Every checkbox
        // column in a list rendered that way ("Bu ayın favorilerinde göster:
        // doğru").
        general: { true: "Evet", false: "Hayır" },
        // The image crop panel was titled "Mahsulat" — "crop" translated as
        // the harvest, not the verb.
        upload: { crop: "Kırpma" },
      },
    },
  },
